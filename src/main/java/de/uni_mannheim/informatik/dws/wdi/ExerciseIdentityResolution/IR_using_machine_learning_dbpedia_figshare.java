...
//		String modelType = "NaiveBayes"; SimpleLogistic; DecisionTable
//				+ ""; // use a logistic regression
		...
		gsTraining.loadFromCSVFile(new File("data/goldstandard/gs_20181114_dbpedia_2_figshare.csv")); //TODO
...
//		correspondences = engine.getTopKInstanceCorrespondences(correspondences, 1, 0.0);
		...
		new CSVCorrespondenceFormatter().writeCSV(new File("data/output/dbpedia_figshare_Athlete_correspondences_ML_with_new_GS.csv"), correspondences);
