...
public class IR_linear_combination_Kaggle_Fig_Hendrik {
	...
	public static void main(String[] args) throws Exception {
		...
		new AthleteXMLReader().loadFromXML(new File("data/input/20181029_figshare_Final.xml"),
				"/WinningAthletes/Athlete", dataAthletesFigshare);
...
//		SortedNeighbourhoodBlocker<Athlete, Attribute, Attribute> blocker = new SortedNeighbourhoodBlocker<>(new AthleteBlockingKeyByEarliestParticipationYearGenerator(), 1500);
		...
		new CSVCorrespondenceFormatter().writeCSV(new File("data/output/kaggle_figshare_Athlete_correspondences.csv"),
				correspondences);

		// load the gold standard (test set)
		System.out.println("*\n*\tLoading gold standard\n*");
		MatchingGoldStandard gsTest = new MatchingGoldStandard();
		gsTest.loadFromCSVFile(new File("data/goldstandard/gs_kaggle_figshare_merged_2.csv"));
