...
/**
* Identity resolution using machine learning for field athletes and figshare dataset.
* 
* @author Marius Bock
* 
*/

public class IR_field_figshare_machine_learning {
    ...
    public static void main( String[] args ) throws Exception
    {
		...
		learner.learnMatchingRule(dataAthletesField, dataAthletesFigshare, null, matchingRule, gsTraining);
		...
		Processable<Correspondence<Athlete, Attribute>> correspondences = engine.runIdentityResolution(
				dataAthletesField, dataAthletesFigshare, null, matchingRule,
				blocker);
		...
		new CSVCorrespondenceFormatter().writeCSV(new File("data/output/field_figshare_ML_correspondences.csv"), correspondences);
