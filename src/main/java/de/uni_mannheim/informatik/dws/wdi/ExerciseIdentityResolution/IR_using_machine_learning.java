...
//		// loading data
//		System.out.println("*\n*\tLoading datasets\n*");
//		HashedDataSet<Athlete, Attribute> dataAcademyAwards = new HashedDataSet<>();
//		new AthleteXMLReader().loadFromXML(new File("data/input/academy_awards.xml"), "/movies/movie", dataAcademyAwards);
//		HashedDataSet<Athlete, Attribute> dataActors = new HashedDataSet<>();
//		new AthleteXMLReader().loadFromXML(new File("data/input/actors.xml"), "/movies/movie", dataActors);
//
...
////		StandardRecordBlocker<Athlete, Attribute> blocker = new StandardRecordBlocker<Athlete, Attribute>(new MovieBlockingKeyByTitleGenerator());
