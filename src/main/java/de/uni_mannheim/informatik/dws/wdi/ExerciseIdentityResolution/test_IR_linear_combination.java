...
public class test_IR_linear_combination 
{
	/*
	 * Logging Options:
    ...
    public static void main( String[] args ) throws Exception
    {
		// loading data
		System.out.println("*\n*\tLoading datasets\n*");
		HashedDataSet<Movie, Attribute> dataDBpedia = new HashedDataSet<>();
		new MovieXMLReader().loadFromXML(new File("data/input/DBpediaFinalTarget.xml"), "/WinningAthletes/Athlete", dataDBpedia);
		HashedDataSet<Movie, Attribute> dataDBpedia2 = new HashedDataSet<>();
		new MovieXMLReader().loadFromXML(new File("data/input/DBpediaFinalTarget2.xml"), "/WinningAthletes/Athlete", dataDBpedia2);
...
//		SortedNeighbourhoodBlocker<Movie, Attribute, Attribute> blocker = new SortedNeighbourhoodBlocker<>(new MovieBlockingKeyByTitleGenerator(), 1);
		...
		Processable<Correspondence<Movie, Attribute>> correspondences = engine.runIdentityResolution(
				dataDBpedia, dataDBpedia2, null, matchingRule,
				blocker);
